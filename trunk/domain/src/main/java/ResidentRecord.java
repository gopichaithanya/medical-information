...
public class ResidentRecord {
	public int getResidentrecordid() {
		return residentrecordid;
	}
	public void setResidentrecordid(int residentrecordid) {
		this.residentrecordid = residentrecordid;
	}
